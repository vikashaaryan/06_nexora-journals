    ...
    <div class="hidden bg-[#1f4f9d] lg:block">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <nav class="flex flex-wrap items-center justify-center gap-x-8 gap-y-3 py-4">
                ...
                <a href="{{ route('journal.submit') }}" class="text-[15px] font-medium text-white transition hover:text-sky-200 {{ request()->routeIs('journal.submit') ? 'underline underline-offset-8' : '' }}">Submit Manuscript</a>
